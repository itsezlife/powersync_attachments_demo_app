...
/// {@template persistent_storage_list}
/// Storage that saves list of data in the device's persistent memory.
/// {@endtemplate}
class PersistentListStorage implements ListStorage {
  /// {@macro persistent_storage_list}
  const PersistentListStorage({
  ...
  @override
  Future<void> write({required String key, required List<String> value}) async {
    try {
